...
import inc.firebok.com.music.activies.ReproPlay;
    ...
    public  void doStuff(){
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(MainActivity.this,"seleccionado "+ " position "+position +" id " + id, Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(MainActivity.this, ReproPlay.class);
